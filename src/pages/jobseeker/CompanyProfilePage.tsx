  ...
  return (
    <div className="profile-page-container">
      ...
      <div className="profile-page-content">
        ...
        <div className="profile-company-banner-section">
          ...
          <div className="profile-company-logo-wrapper">
            ...
            <div className="company-profile-info-header">
              <h1 className="company-profile-name">Công ty TNHH ABC</h1>
              <p className="company-profile-industry">Công nghệ thông tin • 100-500 nhân viên</p>
        ...
        <div className="profile-section">
          ...
          <div className="profile-info-grid">
            ...
            <div className="profile-info-item">
              ...
              <div className="profile-info-value">123 Đường ABC, Quận 1, TP. HCM</div>
            </div>
          </div>
        </div>
        ...
        {/* Benefits Section */}
        <div className="profile-section">
          <h2 className="profile-section-title">Phúc lợi nhân viên</h2>
        ...
        <div className="profile-section">
          <div className="profile-section-header">
            <h2 className="profile-section-title">Vị trí tuyển dụng ({3})</h2>
            <a href="#" className="profile-section-link">Xem tất cả</a>
          </div>

          <div className="company-profile-jobs-list">
            <div className="company-profile-job-card">
              <h3 className="company-profile-job-title">Frontend Developer</h3>
              <div className="company-profile-job-info">
                <span className="company-profile-job-detail">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button className="company-profile-apply-button">Ứng tuyển ngay</button>
            </div>

            <div className="company-profile-job-card">
              <h3 className="company-profile-job-title">Backend Developer</h3>
              <div className="company-profile-job-info">
                <span className="company-profile-job-detail">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
            ...
            <div className="company-profile-job-card">
              <h3 className="company-profile-job-title">UI/UX Designer</h3>
              <div className="company-profile-job-info">
                <span className="company-profile-job-detail">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
